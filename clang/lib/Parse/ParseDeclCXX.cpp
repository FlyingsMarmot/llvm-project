...
void Parser::ParseCXXMemberSpecification(SourceLocation RecordLoc,
  ...
  assert((TagType == DeclSpec::TST_struct ||
          TagType == DeclSpec::TST_interface ||
          TagType == DeclSpec::TST_union || TagType == DeclSpec::TST_class || TagType == DeclSpec::TST_coroutine || TagType == DeclSpec::TST_monitor) &&
         "Invalid TagType!");
  ...
  if ((TagType == DeclSpec::TST_class || TagType == DeclSpec::TST_coroutine || TagType == DeclSpec::TST_monitor) && !getLangOpts().HLSL)
    CurAS = AS_private;
  else
    CurAS = AS_public;
